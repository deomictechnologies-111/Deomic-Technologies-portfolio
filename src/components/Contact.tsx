            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-900">deomictechnologies@gmail.com</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-brand-600">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-900">9757177273</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-slate-100 flex items-center justify-center text-brand-600">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-900">Ghatkopar West, Mumbai, India</p>
                </div>
              </div>
            </div>
